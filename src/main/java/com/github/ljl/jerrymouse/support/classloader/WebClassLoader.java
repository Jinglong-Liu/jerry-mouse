...
public class WebClassLoader extends ClassLoader implements IClassLoader {
    private Path classPath;
    private List<Path> jarPaths;

    public WebClassLoader(Path classPath, Path libPath) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            Path classPath = Paths.get("D:\\java-learning\\jerry-mouse\\src\\test\\webapps\\web-demo\\WEB-INF\\classes");
            WebClassLoader classLoader = new WebClassLoader(classPath, null);

            Class<?> clazz = classLoader.loadClass("com.github.ljl.servlet.web.IndexServlet");
